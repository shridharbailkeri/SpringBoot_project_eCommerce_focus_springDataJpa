...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    // define native SQL query using @Query annotation using index or position params
    ...
    // Define Named native SQL query needs at query annotation
    @Query
